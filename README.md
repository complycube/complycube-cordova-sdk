# ComplyCube Cordova SDK

 ![ComplyCube](statics/cc_loves_cordova.png)
...
### Cordova library
Finally install the Cordova library:
1. Configure the npm registry to use the ComplyCube SDK repository by running the following command in your terminal:

```bash
npm config set @complycube:registry https://complycuberepo.jfrog.io/artifactory/api/npm/cc-cordova-dev-npm-local/

```
2. Setup the `.npmrc` file in the home directory, for windows users the file is located in `C:\Users\{username}\.npmrc` and for Unix based system users the file is located in `~/.npmrc`:

```bash
@complycube:registry=https://complycuberepo.jfrog.io/artifactory/api/npm/cc-cordova-dev-npm-local/
//complycuberepo.jfrog.io/artifactory/api/npm/cc-cordova-dev-npm-local/:_password=<TOKEN>
//complycuberepo.jfrog.io/artifactory/api/npm/cc-cordova-dev-npm-local/:username=<USER_NAME>
//complycuberepo.jfrog.io/artifactory/api/npm/cc-cordova-dev-npm-local/:email=<E-MAIL>
//complycuberepo.jfrog.io/artifactory/api/npm/cc-cordova-dev-npm-local/:always-auth=true
```
3. Install the Cordova library:
