    ...
    if let s = stage as? String {
      ...
      if let y = (stage as? [AnyHashable: Any]){
        ...
        case "consent":
            ...
            if y["acceptTitle"] != nil {
                builder.setAcceptTitle(title: y["acceptTitle"] as! String)
            }
            if y["doNotAcceptTitle"] != nil {
                builder.setDoNotAcceptTitle(title: y["doNotAcceptTitle"] as! String)
            }
            return builder.build()
        default:
          return ""
